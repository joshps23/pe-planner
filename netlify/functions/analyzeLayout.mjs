...
===LAYOUT_OPTIONS===
{"layouts":[{"name":"Ultimate Challenge Arena","description":"Epic point-scoring adventure with power zones and special abilities!","instructions":"GAME MODE for ${studentSkillLevel}: Welcome to the Ultimate Challenge Arena! Attackers are TREASURE HUNTERS collecting points by dribbling through cone gates (10 pts each). Defenders are GUARDIANS protecting the treasure zones. POWER-UP ZONE: Center court gives 2X points for 5 seconds! COMBO BONUS: Pass through 3 gates in 10 seconds for MEGA POINTS (50 pts)!","rules":"GAME RULES: 3-minute rounds, team with most points wins! SPECIAL ABILITIES: Attackers can call FREEZE once per round (defenders stop for 3 seconds). Defenders can create a FORCE FIELD (link arms) once per round for 5 seconds. SUDDEN DEATH: Tie? Golden ball worth 100 points appears!","teachingPoints":"PRO TIPS: Use fake moves to earn style points! Team combos unlock bonus achievements! Speed bursts through gates = extra points! Victory dance in the end zone after scoring!","elements":[{"type":"cone","position":{"xPercent":25,"yPercent":30}},{"type":"cone","position":{"xPercent":70,"yPercent":30}},{"type":"cone","position":{"xPercent":25,"yPercent":70}},{"type":"cone","position":{"xPercent":70,"yPercent":70}},{"type":"cone","position":{"xPercent":47,"yPercent":25}},{"type":"cone","position":{"xPercent":47,"yPercent":70}},{"type":"attacker","position":{"xPercent":30,"yPercent":50}},{"type":"attacker","position":{"xPercent":65,"yPercent":50}},{"type":"defender","position":{"xPercent":47,"yPercent":47}},{"type":"ball","position":{"xPercent":35,"yPercent":35}}]},{"name":"Battle Royale Showdown","description":"Intense team battle with eliminations and epic comebacks!","instructions":"BATTLE MODE for ${studentSkillLevel}: RED TEAM vs BLUE TEAM in the ultimate showdown! Each player has 3 LIVES shown by cone tokens. GET TAGGED = LOSE A LIFE! Last team with players standing wins! REVIVAL CHALLENGE: Eliminated players can earn a life back by completing the sideline skill challenge in 30 seconds!","rules":"BATTLE RULES: NO CAMPING (must move every 5 seconds)! POWER MOVES: SHIELD = 5-second immunity (once per life), TURBO = super speed for 3 seconds (once per game). BOSS MODE: When down to 1 player, they become the BOSS with double speed! VICTORY CONDITION: Eliminate all opponents or have most lives when time expires!","teachingPoints":"CHAMPION STRATEGIES: Use teamwork for combo attacks! Save power moves for critical moments! Create distractions for surprise attacks! Celebrate every elimination with team chant!","elements":[{"type":"cone","position":{"xPercent":40,"yPercent":40}},{"type":"cone","position":{"xPercent":60,"yPercent":40}},{"type":"cone","position":{"xPercent":40,"yPercent":60}},{"type":"cone","position":{"xPercent":60,"yPercent":60}},{"type":"cone","position":{"xPercent":30,"yPercent":50}},{"type":"cone","position":{"xPercent":70,"yPercent":50}},{"type":"attacker","position":{"xPercent":35,"yPercent":45}},{"type":"attacker","position":{"xPercent":35,"yPercent":55}},{"type":"defender","position":{"xPercent":65,"yPercent":50}},{"type":"ball","position":{"xPercent":50,"yPercent":50}}]},{"name":"Adventure Quest Champions","description":"Level-based adventure with boss battles and treasure hunting!","instructions":"QUEST MODE for ${studentSkillLevel}: MISSION - Complete 3 LEVELS to become CHAMPIONS! LEVEL 1: Navigate the Lava Maze (cones = lava) without touching! LEVEL 2: Defeat the Guardian (defender) using skill moves! LEVEL 3: BOSS BATTLE - All attackers vs all defenders for the GOLDEN TREASURE (ball)! Each level completed = new special ability unlocked!","rules":"QUEST RULES: 2 minutes per level! SPECIAL ABILITIES: Level 1 unlock = DASH (burst of speed), Level 2 unlock = PHASE (dodge one tag), Level 3 = ULTIMATE (team super move)! BONUS CHALLENGES: Hidden treasures (cones) worth extra points! EPIC FINALE: Winners perform victory celebration for bonus XP!","teachingPoints":"HERO TRAINING: Master each level before advancing! Use abilities strategically! Work as a team in boss battles! Create your own victory dance! Encourage fallen teammates!","elements":[{"type":"cone","position":{"xPercent":25,"yPercent":35}},{"type":"cone","position":{"xPercent":40,"yPercent":30}},{"type":"cone","position":{"xPercent":55,"yPercent":35}},{"type":"cone","position":{"xPercent":70,"yPercent":30}},{"type":"cone","position":{"xPercent":35,"yPercent":65}},{"type":"cone","position":{"xPercent":60,"yPercent":65}},{"type":"attacker","position":{"xPercent":30,"yPercent":25}},{"type":"attacker","position":{"xPercent":65,"yPercent":25}},{"type":"defender","position":{"xPercent":50,"yPercent":60}},{"type":"ball","position":{"xPercent":47,"yPercent":40}}]}]}
===END===
